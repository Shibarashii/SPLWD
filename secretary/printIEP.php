...
<body id="page-top">
  <div class="container">
    ...
    if (!isset($_GET['lrn']) || !isset($_GET['iep_id'])) {
        die("Error: Missing required parameters 'lrn' or 'iep_id'. Please provide them in the URL.");
    }

    // Sanitize inputs
    $id = mysqli_real_escape_string($conn, $_GET['lrn']);
    $iep = mysqli_real_escape_string($conn, $_GET['iep_id']);
    ...
    $sqldatateam = mysqli_query($conn, $sqlgetteam) or die('Error Displaying Data: ' . mysqli_error($conn));
      ...
      <div class="row border mb-5">
        ...
        <div class="col-md-5 border">
          ...
          <table class table>
            ...
            $sqldata11 = mysqli_query($conn, $sqlget11) or die('Error Displaying Data: ' . mysqli_error($conn));
                ...
                <td>
                  <div class="d-flex justify-content-between">
                    ...
                    <p><strong>Grade:</strong><u>&emsp;<?php
                                                        ...
                                                        $sqldatadiff = mysqli_query($conn, $sqlgetdiff) or die('Error Displaying Data: ' . mysqli_error($conn));
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <table class="table1">
            ...
            $function5_3 = "";
            include('../connect.php');
            $id1 = mysqli_real_escape_string($conn, $_GET['lrn']);
            $f_id = isset($_GET['folder_id']) ? mysqli_real_escape_string($conn, $_GET['folder_id']) : '';
            $iid =  mysqli_real_escape_string($conn, $_GET['iep_id']);
            $sqlget1 = "SELECT * FROM iep_functional WHERE lrn = '$id1' AND folder_id = '$f_id' AND iep_id = '$iid'";
            $sqldata1 = mysqli_query($conn, $sqlget1) or die('Error Displaying Data: ' . mysqli_error($conn));
    ...
    <div class="row">
      ...
      include('../connect.php');
      $id = mysqli_real_escape_string($conn, $_GET['lrn']);
      $iep_id = mysqli_real_escape_string($conn, $_GET['iep_id']);
      $sqlget2 = "SELECT * FROM iep_special_factor WHERE lrn = '$id' AND iep_id = '$iep_id'";
      $sqldata2 = mysqli_query($conn, $sqlget2) or die('Error Displaying Data: ' . mysqli_error($conn));
    ...
    <div class="row">
      ...
      <table class="table1 table-sm table-bordered">
        ...
        $sqldata3 = mysqli_query($conn, $sqlget3) or die('Error Displaying Data: ' . mysqli_error($conn));
    ...
    <div class="row">
      ...
      <table class="table1 table-sm table-bordered">
        ...
        $sqldata4 = mysqli_query($conn, $sqlget4) or die('Error Displaying Data: ' . mysqli_error($conn));
      ...
      <table class="table1 table-sm table-bordered">
        ...
        include('../connect.php');
        $id1 = mysqli_real_escape_string($conn, $_GET['lrn']);
        $folder_id = isset($_GET['folder_id']) ? mysqli_real_escape_string($conn, $_GET['folder_id']) : '';
        $sqlget5 = "SELECT * FROM iep_transition WHERE lrn = '$id' AND folder_id = '$folder_id' AND iep_id = '$iep_id'";
        $sqldata5 = mysqli_query($conn, $sqlget5) or die('Error Displaying Data: ' . mysqli_error($conn));
