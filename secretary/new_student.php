            ...
            <div class="tab-content" align="center" id="myTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Expresses need to eat drink through non-verbal and or verbal means </td><input type="hidden" name="11" value="Expresses need to eat drink through non-verbal and or verbal means">
                                        <td>
                                    ...
                                    <tr>
                                        <td>Uses toilet paper to clean-up and disposes it properly</td><input type="hidden" name="115" value="Uses toilet paper to clean-up and disposes it properly">
                                        <td>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Uses courteous expressions appropriately</td><input type="hidden" name="21" value="Uses courteous expressions appropriately">
                                        <td>
                                    ...
                                    <tr>
                                        <td>Identifies personal belongings</td><input type="hidden" name="215" value="Identifies personal belongings">
                                        <td>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Follows simple direction</td><input type="hidden" name="31" value="Follows simple direction">
                                        <td>
                                    ...
                                    <tr>
                                        <td>Traces letters, numbers and one’s names properly</td><input type="hidden" name="316" value="Traces letters, numbers and one’s names properly">
                                        <td>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Sits, stand and walks with good posture</td><input type="hidden" name="41" value="Sits, stand and walks with good posture">
                                        <td>
                                    ...
                                    <tr>
                                        <td>Cuts out shapes, outline & objects</td><input type="hidden" name="419" value="FCuts out shapes, outline & objects">
                                        <td>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Identifies colors</td><input type="hidden" name="51" value="Identifies colors">
                                        <td>
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-6">
                                <table style="font-size:12px;" class="table table-bordered ">
                                    ...
                                    <tr>
                                        <td>Uses appropriate verbal communication for social interaction </td><input type="hidden" name="61" value="Uses appropriate verbal communication for social interaction">
                                        <td>
                                    ...
                                    <tr>
                                        <td>Takes turn in game activity</td><input type="hidden" name="617" value="Takes turn in game activity">
                                        <td>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table p-3">
                        ...
                        <tr>
                            <td colspan="3"> <input type="submit" value="ADD STUDENT" class="btn btn-primary float-right" name="submit"></td>
                        </tr>
                    </table>
                </div>
                <!--Assessment tab-->
