<div class="row" style="  display: grid;
  ...
  border-collapse: collapse;">4</th>
            ...
            <tr align="center">
                <th style="  border: 1px solid black;
  border-collapse: collapse;" colspan="6">Daily Living Skill Domain</th>
            </tr>
            <tr>
                <th style="  border: 1px solid black;
  border-collapse: collapse;" colspan="6">Self feeding</th>
            </tr>
            <?php
            include('../connect.php');
            $id = 1234567;
  ...
  border-collapse: collapse;">4</th>
            ...
            <tr align="center">
                <th style="  border: 1px solid black;
  border-collapse: collapse;" colspan="6">SOCIO-EMOTIONAL DOMAIN</th>
            </tr>
            <?php
            include('../connect.php');
            $id2 = 1234567;
  ...
  border-collapse: collapse;">4</th>
            ...
            <tr align="center">
                <th style="  border: 1px solid black;
  border-collapse: collapse;" colspan="6">LANGUAGE DEVELOPMENT</th>
            </tr>
            <tr>
                <th style="  border: 1px solid black;
  border-collapse: collapse;">LISTENING</th>
            </tr>
            <?php
            include('../connect.php');
            $id21 = 1234567;
  ...
  border-collapse: collapse;">4</th>
            ...
            <tr align="center">
                <th style="  border: 1px solid black;
  border-collapse: collapse;" colspan="6">PYSCHOMOTOR DOMAIN</th>
            </tr>
            <?php
            include('../connect.php');
            $id2 = 1234567;
  ...
  border-collapse: collapse;" rowspan="2">final rating</th>
            ...
            <tr align="center">
                <th style="  border: 1px solid black; border-collapse: collapse;" colspan="6">PCOGNITIVE DOMAIN</th>
            </tr>
            <?php
            include('../connect.php');
            $id2 = 1234567;
            ...
            ?>
                <tr>
                    <td style="  border: 1px solid black; border-collapse: collapse;"><?php echo $row5['type']; ?> <input type="hidden" name="5<?php echo $count; ?>" value="<?php echo $row5['type']; ?>">
    ...
    <!--SIX-->
    <div class="col-md-6" style="padding:5px;">
        <table style=" font-size:8px;  border: 1px solid black; border-collapse: collapse; width: 100%;" class="table table-bordered">
            <tr>
                <th style="  border: 1px solid black; border-collapse: collapse;" rowspan="2">LEARNING AREAS</th>
                <th style="  border: 1px solid black; border-collapse: collapse;" colspan="4">Periodic Rating</th>
                <th style="  border: 1px solid black; border-collapse: collapse;" rowspan="2">final rating</th>
            </tr>
            <tr>
                <th style="  border: 1px solid black; border-collapse: collapse;">1</th>
                <th style="  border: 1px solid black; border-collapse: collapse;">2</th>
            ...
            ?>
                <tr>
                    <td style="  border: 1px solid black; border-collapse: collapse;"><?php echo $row6['type']; ?> </td><input type="hidden" name="6<?php echo $count; ?>" value="<?php echo $row6['type']; ?>">
                    <td style="  border: 1px solid black; border-collapse: collapse;">
                        <?php if ($row6['q1'] == '') { ?>
                        <?php } else {
                            echo $row6['q1'];
