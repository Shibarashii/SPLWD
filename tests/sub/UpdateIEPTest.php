...
class MockMysqliResultUpdateIEP {
    private $data;
    private $index = 0;
...
class UpdateIEPTest extends TestCase
{
    private $conn;
    private $headers;
    ...
    protected function setUp(): void
    {
        ...
        $this->conn = new MockMysqliUpdateIEP();
    ...
    public function testUpdateBarriers()
    {
        ...
        $mockConn = new MockMysqliUpdateIEP();
        $mockResult = new MockMysqliResultUpdateIEP($barriersData);
    ...
    public function testUpdateGoals()
    {
        ...
        $mockConn = new MockMysqliUpdateIEP();
        $mockResult = new MockMysqliResultUpdateIEP($goalsData);
    ...
    public function testUpdateTransitions()
    {
        ...
        $mockConn = new MockMysqliUpdateIEP();
        $mockResult = new MockMysqliResultUpdateIEP($transitionsData);
    ...
    public function testUpdateFailure()
    {
        ...
        $conn = new MockMysqliUpdateIEP(false);
        $id = $_GET['id'];
