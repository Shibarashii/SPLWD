...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav <?php if (isset($_GET['color'])) {
        ...
        <li class="nav-item">
            <a class="nav-link" href="folders.php">
                ...
                <span style="font-size: 18px;">Student Folders</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="new_student.php">
                ...
                <span style="font-size: 18px;">Add Student</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="log.php">
                ...
                <span style="font-size: 18px;">Log History</span>
            </a>
        </li>
        <li class="nav-item">
