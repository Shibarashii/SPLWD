          ...
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-center">
                <p style="color:black;"> School year:</p> _<u><?php echo $rowbir['school_year']; ?></u>_______
              </div>
            </td>
          </tr>
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-center">
                <p style="color:black;"> Date of Observation:_<u><?php echo $rowbir['date']; ?></u>_______
              </div>
            </td>
          </tr>
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-left">
                <p style="color:black;"> Name of Learners: _<u><?php echo $name; ?></u>_______ </p>
              </div>
            </td>
          </tr>
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-left">
                <p style="color:black;"> Learner’s Reference Number : _<u><?php echo $_GET['lrn']; ?></u>_______ </p>
              </div>
            </td>
          </tr>
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-left">
                <p style="color:black;"> Date of Birth : _<u><?php echo $birth_date; ?></u>_______ </p>
              </div>
            </td>
          </tr>
          <tr>
            <td style="color:black;">
              <div class="d-flex justify-content-left">
                <p style="color:black;"> Age of Learner: _<u> <?php
                                                              $date = date_create($birth_date);
                                                              $interval = $date->diff(new DateTime);
                                                              echo $interval->y;
                                                              ?></u>_____ Gender: _<u><?php echo $gender; ?></u>_______ </p>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <tr>
              <td style="color:black;">
                <div class="d-flex justify-content-center">
                  ...
                  <div><input style="color:black;" type="text" class="form-control" value="<?php echo $guardian; ?>" style="width:300px">
