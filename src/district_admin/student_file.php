...
<body id="page-top">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-md-2 border vh-100">
        ...
        ?>
          <h5><strong>Name : </strong><?php $name = $row['fname'] . " " . $row['lname'];
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <table class="table table-bordered">
                              <tr>
                                <td colspan="8">Learner's name: <?php echo $name; ?></td>
                              </tr>
                              <tr>
                                <td colspan="8">Grade level: <?php echo $grade; ?></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td colspan="6"><input type="checkbox" name="c_2"> Learner is making significant progress. Continue with the learning plan. </td>
                              </tr>
                              <tr>
                              ...
                              <table class="table table-sm">
                                ...
                                <tr>
                                  <td>
                                    <div class="row">
                                      ...
                                      <div class="col-md-3"><input type="date" name="date_interview" class="form-control"></div>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td>
                                    <div class="row">
                                      <div class="col-md-3">Date of Interview:</div>
                                      <div class="col-md-3"><input type="date" name="date_interview_student" class="form-control"></div>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <div class="col-md-5 border">
                                  ...
                                  <table class="table">
                                    ...
                                    ?>
                                      <tr>
                                        <td>
                                          <p><strong>LEARNER: </strong> <?php $category = $row31['category'];
                                      ...
                                      <tr>
                                        <td>
                                          <p><strong>Gender:</strong> <?php echo " " . $row31['gender']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Birth Date:</strong><?php echo " " . $row31['birth_date']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Grade/Level:</strong> <select name="grade" id="" class="form-control">
                                      ...
                                      <tr>
                                        <td>
                                          <p><strong>LRN:</strong><?php echo " " . $row31['lrn']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Current School:</strong><?php echo " " . $row31['school']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Address of School:</strong><?php $address = $row31['address'];
                                      ...
                                      <tr>
                                        <td>
                                          <p><strong>Mother Tongue Spoken:</strong><?php echo " " . $row31['m_tounge']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Address:</strong><?php echo " " . $row31['address']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                      ...
                                      <tr>
                                        <td>
                                          <p><strong>Work & Workplace:</strong><?php echo " " . $row31['work']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Landline/Cell Phone No.:</strong><?php $contact = $row31['gurdian_contact'];
                                                                                      echo " " . $row31['gurdian_contact']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Email:</strong><?php echo " " . $row31['email']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Mother Tongue Spoken:</strong><?php echo " " . $row31['guardian_mtounge']; ?></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                          <p><strong>Interpreter or other Accomodations Needed:</strong><br><textarea name="others_2" class="form-control"></textarea></p>
                                        </td>
                                      </tr>
                                    <?php } ?>
                                  </table>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-12" align="left">
                                  ...
                                  <table class="table">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_3" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_4" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_5" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_6" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_7" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><textarea name="comment_8" id="" class="form-control"></textarea></td>
                                    </tr>
                                    <tr>
                                      <td colspan="2">
                                    ...
                                    <tr>
                                      <td colspan="4"><input type="radio" name="factor_8_type" value="Braille"> Braille
                                        ...
                                        <input type="radio" name="factor_8_type" value="Electronic text"> Electronic text
                                      </td>
                                    </tr>
                                    <tr>
                                      <td colspan="4"><textarea name="comment_9" id="" class="form-control"></textarea></td>
                                    </tr>
                                  </table>
                                </div>
                              </div>
                                  ...
                                  <table class="table">
                                    <tr>
                                      <td colspan="3" align="center">
                                        <p><br>________<?php echo $guardian; ?>_______</p>
                                ...
                                <div class="tab-pane fade" id="functionUpdate" role="tabpanel" aria-labelledby="a1-tab" align="left">
                                  <div class="row">
                                    ...
                                    <table class="table table-bordered">
                                      ...
                                      <tr>
                                        <td> <textarea name="functional_1_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_1_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function1_3; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr class="bg-secondary text-white">
                                        <th>Description of academic, developmental and/or functional strengths:</th>
                                      ...
                                      <tr>
                                        <td> <textarea name="functional_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_2_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_2_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function2_3; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr class="bg-secondary text-white">
                                        <th>Description of academic, developmental and/or functional needs:</th>
                                      ...
                                      <tr>
                                        <td> <textarea name="functional_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_3_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_3_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function3_3; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr class="bg-secondary text-white">
                                        <th>Parental concerns regarding their child’s education:</th>
                                      ...
                                      <tr>
                                        <td> <textarea name="functional_4" class="form-control" id="" cols="30" rows="2"><?php echo  $function4; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_4_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_4_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function4_3; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr class="bg-secondary text-white">
                                        <th>Impact of the disability on involvement and progress in the general education curriculum (for preschool, how the disability affects participation in appropriate activities).</th>
                                      ...
                                      <tr>
                                        <td> <textarea name="functional_5" class="form-control" id="" cols="30" rows="2"><?php echo  $function5; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_5_2" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_2; ?></textarea></p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td> <textarea name="functional_5_3" class="form-control" id="" cols="30" rows="2"><?php echo  $function5_3; ?></textarea></p>
                                        </td>
                                      </tr>
                                    </table>
                                  </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-12" align="left">
                                      ...
                                      <table class="table">
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_3" class="form-control" id="" cols="30" rows="2"><?php echo $comment3; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner have difficulty in seeing or with blindness/visual impairment?
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_4" class="form-control" id="" cols="30" rows="2"><?php echo $comment4; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner have difficulty in communicating?
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_5" class="form-control" id="" cols="30" rows="2"><?php echo $comment5; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner have difficulty in concentrating/paying attention?
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_6" class="form-control" id="" cols="30" rows="2"><?php echo $comment6; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner have difficulty in hearing or Is the learner deaf or hard of hearing?</strong>
                                              If yes, consider and describe the learner’s language and communication needs, opportunities for direct communication with peers and professional personnel in the
                                              learner’s language and communication mode, academic level and full range of needs, including opportunities for direct instruction in the learner’s language and
                                              communication mode. Describe communication needs below.
                                            </p>
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_7" class="form-control" id="" cols="30" rows="2"><?php echo $comment7; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner need assistive technology devices or services?</strong>
                                              If yes, describe the type of assistive technology and how it is used. If no, describe how the learner’s needs are being met in deficit areas
                                            </p>
                                          </td>
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_8" class="form-control" id="" cols="30" rows="2"><?php echo $comment8; ?></textarea> </td>
                                        </tr>
                                        <tr>
                                          <td colspan="2">
                                            <p>Does the learner require alternative format for instructional materials?</strong>
                                              If yes, specify format(s) of materials required below.
                                            </p>
                                          </td>
                                        ...
                                        <tr>
                                          <td colspan="4"><textarea name="comment_9" class="form-control" id="" cols="30" rows="2"><?php echo $comment9; ?></textarea> </td>
                                        </tr>
                                      </table>
                                    </div>
                                  </div>
                                  ...
                                  <div class="row border">
                                    ...
                                    <div class="col-md-3 border">
                                      <table class="table">
                                        <tr>
                                          <td>
                                            <p><strong>Grade/Level:</strong> <select name="grade" class="form-control" id="">
                                        ...
                                        <tr>
                                          <td>
                                            <p><strong>Interpreter or other Accomodations Needed:</strong><br><textarea name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p>
                                          </td>
                                        </tr>
                                      </table>
                                    </div>
                                    ...
                                    <div class="col-md-4 border" align="left">
                                      DIFFICULTIES (Select most relevant):
                                      <p><input name="d_seeing" type="checkbox" <?php if ($d_seeing != '') {
                                                                                  echo 'checked';
                                                                                }  ?> value="1"> Difficulty in Seeing</p>
                                      <p><input name="d_hearing" <?php if ($d_hearing != '') {
                                                                    echo 'checked';
                                                                  }  ?> type="checkbox" value="1"> Difficulty in Hearing</p>
                                      <p><input name="d_com" type="checkbox" <?php if ($d_com != '') {
                                                                                echo 'checked';
                                                                              }  ?> value="1"> Difficulty in Communicating</p>
                                      <p><input name="d_moving" type="checkbox" <?php if ($d_moving != '') {
                                                                                  echo 'checked';
                                                                                }  ?> value="1"> Difficulty in Moving/Walking</p>
                                      <p><input type="checkbox" name="d_concentrating" <?php if ($d_concentrating != '') {
                                                                                          echo 'checked';
                                                                                        }  ?> value="1"> Difficulty in Concentrating/Paying
                                        Attention </p>
                                      <p><input type="checkbox" name="d_remembering" <?php if ($d_remembering != '') {
                                                                                        echo 'checked';
                                                                                      }  ?> value="1"> Difficulty in Remembering/
                                        Understanding</p>
                                      <p><input type="checkbox" name="d_other" <?php if ($d_others != '') {
                                                                                  echo 'checked';
                                    ...
                                    <div class="col-md-5 border" align="left">
                                      ...
                                      <strong>PURPOSE OF MEETING:</strong>
                                      <p><input name="purpose" <?php if ($purpose == '1') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="1"> Interim IEP</p>
                                      <p><input name="purpose" <?php if ($purpose == '2') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="2"> Initial IEP</p>
                                      <p><input name="purpose" <?php if ($purpose == '3') {
                                                                  echo 'checked';
                                                                }   ?> type="radio" value="3"> Term IEP</p>
                                      <p><input name="purpose" <?php if ($purpose == '4') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="4"> IEP Following 3-Yr, Reevaluation</p>
                                      <p><input name="purpose" <?php if ($purpose == '5') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="5"> Revision to IEP Date <input value="<?php echo $review_date; ?>" type="date" name="review_date"></p>
                                      <p><input name="purpose" <?php if ($purpose == '6') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="6"> Exit/Graduation</p>
                                      <p> IEP Revision Without a Meeting At the request of </p>
                                      <p> <input name="purpose" <?php if ($purpose == '7') {
                                                                  echo 'checked';
                                                                }  ?> type="radio" value="7">Parent</p>
                                      <p> <input name="purpose" type="radio" <?php if ($purpose == '8') {
                                                                                echo 'checked';
                                                                              } ?> value="8">School</p>
                                      <p>IEP Review Date</p>
                                ...
                                <div class="row">
                                  ...
                                  <table class="table table-bordered">
                                    ...
                                    ?>
                                      ...
                                      <tr>
                                        <td><?php $date1 = $rowilp1['date_interview'];
                                            echo $rowilp1['type_assessment']; ?></td>
                                        <td><?php $date2 = $rowilp1['date_interview_student'];
                                            echo $rowilp1['date']; ?></td>
                                        <td><?php echo $rowilp1['chronological_age']; ?></td>
                                        <td><?php $admin_ilp = $rowilp1['administrator'];
                                            echo $rowilp1['administrator']; ?></td>
                                        <td><?php $result = $rowilp1['result'];
                                            echo $rowilp1['result']; ?></td>
                                      </tr>
                                    <?php } ?>
                                  </table>
                                  <table class="table">
                                    <tr>
                                      <td>
                                        <p><strong>Interview with Parents/Guardian</strong></p>
                                      </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                      <td>
                                        <p>Name of Parent/Guardian: <?php echo $guardian; ?></p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Interview with the Learner</strong></p>
                                      </td>
                                    </tr>
                                    <tr>
                                  ...
                                  <table class="table table-sm">
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_1']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_1']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_2']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_2']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_3']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_3']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_4']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_4']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                        <p><strong>AESTHETIC AND CREATIVE DOMAIN:</strong> Present Level of Educational Performance</p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_5']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_5']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                    ...
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_6']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_6']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr class="bg-secondary text-white">
                                      <td>
                                        <p><strong>ORIENTATION AND MOBILITY:</strong> Present Level of Educational Performance</p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Strength/s: </strong><u><?php echo $rowilp['strenght_7']; ?></u> </p>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td>
                                        <p><strong>Need/s: </strong><u><?php echo $rowilp['need_7']; ?></u> </p>
                                      </td>
                                    </tr>
                                  </table>
                                  <!-- content ng aaaaa1 -->
                ...
                <div class="row border">
                  ...
                  <div class="col-md-3 border">
                    <table class="table">
                      <tr>
                        <td>
                          <p><strong>Grade/Level:</strong> <input readonly type="text" class="form-control" value="<?php echo $grade; ?>"> </p>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <p><strong>Interpreter or other Accomodations Needed:</strong><br><textarea disabled name="others_2" class="form-control"><?php echo $others_2; ?></textarea></p>
                        </td>
                      </tr>
                    </table>
                  </div>
                  ...
                  <div class="col-md-5 border" align="left">
                    ...
                    <p><input <?php if ($purpose == '5') {
                                ...
                                echo 'disabled';
                              } ?> type="radio" name="purpose" value="5"> Revision to IEP Date <input value="<?php echo $review_date; ?>" readonly type="date" name="review_date"></p>
                    ...
                    <p> <input type="radio" <?php if ($purpose == '8') {
                                              echo 'checked';
                                            } else {
                                              echo 'disabled';
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <td rowspan="2" colspan="2">
                        ...
                        <p>Distribution:</p>
                        <p><input type="checkbox" <?php if ($dis_1 == '1') {
                                                    echo 'checked';
                                                  } else {
                                                    echo 'disabled';
                                                  } ?> value="1" name="dis_1"> Learner’s Folder</p>
                        <p> <input type="checkbox" <?php if ($dis_1 == '2') {
                                                      echo 'checked';
                                                    } else {
                                                      echo 'disabled';
                  ...
                  <div class="col-md-12" align="left">
                    ...
                    <table class="table table-bordered">
                      ...
                      ?>
                        <tr>
                          <td>
                            <p><?php echo $row3['barrier_1']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row3['barrier_2']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row3['barrier_3']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row3['barrier_4']; ?></p>
                          </td>
                        </tr>
                      <?php }
                      ?>
                  ...
                  <div class="col-md-12" align="left">
                    ...
                    <table class="table table-bordered">
                      ...
                      ?>
                        <tr>
                          <td>
                            <p><?php echo $row4['interest']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['goal']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['intervention']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['timeline']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['individual_responsible']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['remarks']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row4['progress']; ?></p>
                          </td>
                        </tr>
                      <?php }
                      ?>
                    ...
                    <table class="table table-bordered">
                      ...
                      ?>
                        <tr>
                          <td>
                            <p><?php echo $row5['interest']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row5['work']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row5['skills']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row5['individual_responsible']; ?></p>
                          </td>
                          <td>
                            <p><?php echo $row5['remarks']; ?></p>
                          </td>
                        </tr>
                      <?php }
                      ?>
                  ...
                  <div class="col-md-6">
                    <table align="left" class="table table-bordered">
                      ...
                      <tr>
                        <td>Last Name:</td>
                        <td>
                          <input type="text" name="lname" value="<?php echo $row3['lname']; ?>" disabled class="form-control" placeholder="Last Name">
                        </td>
                      </tr>
                      <tr>
                        <td>Middle Name:</td>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">Daily Living Skill Domain</th>
                                      </tr>
                                      <tr>
                                        <th colspan="6">Self feeding</th>
                                      </tr>
                                      <?php
                                      include('../connect.php');
                                      $id = $_GET['id'];
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row1['type']; ?> </td><input type="hidden" name="1<?php echo $count; ?>" value="<?php echo $row1['type']; ?>">
                                          <td>
                                            <?php if ($row1['q1'] == '') { ?>
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">SOCIO-EMOTIONAL DOMAIN</th>
                                      </tr>
                                      <?php
                                      include('../connect.php');
                                      $id2 = $_GET['id'];
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row2['type']; ?> </td><input type="hidden" name="2<?php echo $count; ?>" value="<?php echo $row2['type']; ?>">
                                          <td>
                                            <?php if ($row2['q1'] == '') { ?>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">LANGUAGE DEVELOPMENT</th>
                                      </tr>
                                      <tr>
                                        <th>LISTENING</th>
                                      </tr>
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row13['type']; ?> </td><input type="hidden" name="3<?php echo $count; ?>" value="<?php echo $row13['type']; ?>">
                                          <td>
                                            <?php if ($row13['q1'] == '') { ?>
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">PYSCHOMOTOR DOMAIN</th>
                                      </tr>
                                      <?php
                                      include('../connect.php');
                                      $id2 = $_GET['id'];
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row4['type']; ?> </td><input type="hidden" name="4<?php echo $count; ?>" value="<?php echo $row4['type']; ?>">
                                          <td>
                                            <?php if ($row4['q1'] == '') { ?>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">PCOGNITIVE DOMAIN</th>
                                      </tr>
                                      <?php
                                      include('../connect.php');
                                      $id2 = $_GET['id'];
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row5['type']; ?> <input type="hidden" name="5<?php echo $count; ?>" value="<?php echo $row5['type']; ?>">
                                          <td>
                                            <?php if ($row5['q1'] == '') { ?>
                                  ...
                                  <div class="col-md-6">
                                    <table class="table table-bordered">
                                      ...
                                      <tr align="center">
                                        <th colspan="6">BEHAVIORAL DEVELOPMENT</th>
                                      </tr>
                                      <?php
                                      include('../connect.php');
                                      $id2 = $_GET['id'];
                                      ...
                                      ?>
                                        <tr>
                                          <td><?php echo $row6['type']; ?> </td><input type="hidden" name="6<?php echo $count; ?>" value="<?php echo $row6['type']; ?>">
                                          <td>
                                            <?php if ($row6['q1'] == '') { ?>
  ...
  <script>
    function showname() {
      ...
      const f = text.split(".");
      if (f[1] != 'pdf') {
        swal("Please Select PDF file only!", {
          icon: "warning"
        });
        input.value = "";
      }
