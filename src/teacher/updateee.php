...
<body id="page-top">
  ...
  <table class="table table-borderless" style="text-align:center;">
    <tr>
      <td>
        <div class="d-flex justify-content-center">
          <p> School year:</p> <input type="number" style="width:150px;" class="form-control ml-3" name="school_year">
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div class="d-flex justify-content-center">
          <p> Date of Observation:</p> <input type="date" style="width:150px;" class="form-control ml-3" name="date_observation">
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div class="d-flex justify-content-left">
          <p> Name of Learners: </p> <input type="text" style="width:150px;" class="form-control ml-3" name="date_observation">
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div class="d-flex justify-content-left">
          <p> Learner’s Reference Number : </p> <input type="text" style="width:150px;" class="form-control ml-3" name="date_observation">
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div class="d-flex justify-content-left">
          <p> Date of Birth : </p> <input type="text" style="width:150px;" class="form-control ml-3" name="date_observation">
        </div>
      </td>
    </tr>
    <tr>
      <td>
        <div class="d-flex justify-content-left">
          <p> Age of Learner: ______________________ Gender: Male Female : </p> <input type="text" style="width:150px;" class="form-control ml-3" name="date_observation">
        </div>
      </td>
    </tr>
    <tr>
    ...
    <tr style="text-align:left">
      <td>
        <p> Parents: _____________________________ </p>
  ...
  <table class="table table-bordered">
    <tr>
      <td>
        <p> Targeted Behavior (Behavior to be decreased)</p>
        <p></p>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        <div class="d-flex justify-content-center">
          ...
          <div><input type="text" class="form-control" style="width:300px">
