...
<body id="page-top">
  ...
  <div class="container-fluid">
    ...
    <div class="d-sm-flex mb-4">
      ...
      <h1 class="h3 mb-0 text-gray-800">Student File of <?php include('../connect.php');
                                                        if (isset($_GET['id'])) $iddddd = $_GET['id']; {
                                                          $sqlget71 = "SELECT * FROM new_student where lrn=$iddddd";
          ...
          <div class="col-md-7 bg-light p-3">
            ...
            ?>
              <table align="left" class="table">
                <tr>
                  <td>LRN:</td>
                  <td><input type="number" name="lrn" class="form-control" placeholder="Student LRN" value="<?php $_SESSION['lrn'] = $row3['lrn'];
                                                                                                            echo $row3['lrn']; ?>" readonly></td>
                </tr>
                <tr>
                  <td>Student code:</td>
                  <td><input type="text" name="student_code" class="form-control" placeholder="Student Code" value="<?php echo $row3['student_code'];
                                                                                                                    $_SESSION['code'] = $row3['student_code']; ?>" readonly></td>
                </tr>
                <tr>
                  <td>Birth Date:</td>
                          ...
                          <div class="col-md-5 border">
                            ...
                            <table class="table">
                              ...
                              ?>
                                <tr>
                                  <td>
                                    <p><strong>LEARNER: </strong> <?php echo " " . $row31['fname'] . " " . $row31['mname'] . " " . $row31['lname'];
                                ...
                                <tr>
                                  <td>
                                    <p><strong>Address of School:</strong><?php echo " " . $row31['school']; ?></p>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                ...
                                <tr>
                                  <td>
                                    <p><strong>Landline/Cell Phone No.:</strong><?php echo " " . $row31['gurdian_contact']; ?></p>
                                  </td>
                                </tr>
                                <tr>
                                  <td>
