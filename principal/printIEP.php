                ...
                <td>
                  <div class="d-flex justify-content-between">
                    ...
                    <p><strong>Grade:</strong><u>&emsp;<?php
                                                        ...
                                                        ?>&emsp;</u> &emsp;</p>
                    <p><strong>LRN:</strong><u>&emsp;<?php echo " " . $row31['lrn']; ?>&emsp;</u></p>
                  </div>
                </td>
              </tr>
              <tr>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <table class="table table-sm table-bordered">
            ...
            <tr>
              <td>
                <p><strong> <?php echo $pieces1[0]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces1[1]; ?></strong> </p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces1[2]; ?></strong> </p>
              </td>
            </tr>
            ...
            <tr>
              <td>
                <p><strong> <?php echo $pieces2[0]; ?></strong> </p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces2[1]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces2[2]; ?></strong></p>
              </td>
            </tr>
            <tr class="bg-secondary text-white">
            ...
            <tr>
              <td>
                <p><strong> <?php echo $pieces3[0]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces3[1]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces3[2]; ?></strong></p>
              </td>
            </tr>
            <tr class="bg-secondary text-white">
            ...
            <tr>
              <td>
                <p><strong> <?php echo $pieces4[0]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces4[1]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces4[2]; ?></strong></p>
              </td>
            </tr>
            <tr class="bg-secondary text-white">
            ...
            <tr>
              <td>
                <p><strong> <?php echo $pieces5[0]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces5[1]; ?></strong></p>
              </td>
            </tr>
            <tr>
              <td>
                <p><strong> <?php echo $pieces5[2]; ?></strong></p>
              </td>
            </tr>
          </table>
        </div>
