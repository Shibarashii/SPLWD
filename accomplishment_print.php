        ...
        <div class="box-body">
          <div style="text-align:center">
            <p><span style="font:10px Calibri">Republic of the Philippines<br></span>
              ...
              <span style="font:12px Calibri"><b>WEEKLY ACCOMPLISHMENT REPORT</span></b>
            </p><br>
          ...
          <div style="margin-left: 20px;margin-top:30px">
            ...
            <p><span style="font: bold 10px Arial;"> Prepared by: &nbsp&nbsp</span><span style="font: bold 11px Arial; text-decoration: underline;"><?php echo "$fname"; ?>&nbsp<?php echo "$lname"; ?> </span>
              <span style="font: bold 10px Arial; margin-left: 300px"> Reviewed by: &nbsp&nbsp</span><span style="font: bold 11px Arial; text-decoration: underline;">REYNALEN C. JUSTO, MM-ITM,LPT</span>
            </p>
            <p><span style="font: bold 10px Arial; margin-left: 100px">&nbsp&nbsp</span><span style="font: bold 11px Arial;">Faculty </span>
              <span style="font: bold 11px Arial; margin-left: 400px"> College Dean/Associate Dean</span>
            </p>
          </div>
        </div>
        <!-- /.box-body -->
