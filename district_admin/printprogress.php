    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <table class="table1 table-sm table-bordered">
          ...
          <tr align="center" class="text-dark" style="background-color:yellow;">
      ...
      <div class="col-md-6 mt-5">
        ...
        <table class="table" style="text-align:center;">
          <tr>
            <th colspan="3">
              <h5> Parent's/guardian Observation and Signature</h5>
            </th>
          </tr>
          <tr>
            <th>Quarter</th>
          ...
          <strong>
            <h7> Name: ___<u><?php echo $name; ?></u>___ <br>
              Age: _<?php $date = date_create($birth_date);
                    ...
                    echo $interval->y; ?>_ Date of Birth: __<u><?php echo $birth_date; ?></u>__ Sex: __<u><?php echo $gender; ?></u>__</h7>
          </strong>
          <table>
            <tr>
              <td>
