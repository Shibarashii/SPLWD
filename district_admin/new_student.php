            ...
            <div class="tab-content" align="center" id="myTabContent">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Expresses need to eat drink through non-verbal and or verbal means </td><input style="color:black;" type="hidden" name="11" value="Expresses need to eat drink through non-verbal and or verbal means">
                                            <td style="color:black;">
                                        ...
                                        <tr>
                                            <td style="color:black;">Uses toilet paper to clean-up and disposes it properly</td><input style="color:black;" type="hidden" name="115" value="Uses toilet paper to clean-up and disposes it properly">
                                            <td style="color:black;">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Uses courteous expressions appropriately</td><input style="color:black;" type="hidden" name="21" value="Uses courteous expressions appropriately">
                                            <td style="color:black;">
                                        ...
                                        <tr>
                                            <td style="color:black;">Identifies personal belongings</td><input style="color:black;" type="hidden" name="215" value="Identifies personal belongings">
                                            <td style="color:black;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Follows simple direction</td><input style="color:black;" type="hidden" name="31" value="Follows simple direction">
                                            <td style="color:black;">
                                        ...
                                        <tr>
                                            <td style="color:black;">Traces letters, numbers and one’s names properly</td><input style="color:black;" type="hidden" name="316" value="Traces letters, numbers and one’s names properly">
                                            <td style="color:black;">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Sits, stand and walks with good posture</td><input style="color:black;" type="hidden" name="41" value="Sits, stand and walks with good posture">
                                            <td style="color:black;">
                                        ...
                                        <tr>
                                            <td style="color:black;">Cuts out shapes, outline & objects</td><input style="color:black;" type="hidden" name="419" value="FCuts out shapes, outline & objects">
                                            <td style="color:black;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Identifies colors</td><input style="color:black;" type="hidden" name="51" value="Identifies colors">
                                            <td style="color:black;">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-6">
                                    <table style="font-size:12px;" class="table table-bordered ">
                                        ...
                                        <tr>
                                            <td style="color:black;">Uses appropriate verbal communication for social interaction </td><input style="color:black;" type="hidden" name="61" value="Uses appropriate verbal communication for social interaction">
                                            <td style="color:black;">
                                        ...
                                        <tr>
                                            <td style="color:black;">Takes turn in game activity</td><input style="color:black;" type="hidden" name="617" value="Takes turn in game activity">
                                            <td style="color:black;">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table p-3">
                        ...
                        <tr>
                            <td style="color:black;" colspan="3"> <input type="submit" value="ADD STUDENT" class="btn btn-primary float-right" name="submit"></td>
                        </tr>
                    </table>
                </div>
                <!--Assessment tab-->
