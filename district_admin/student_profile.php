...
<body>
  ...
  <a href="student_folder.php?lrn=<?php if (isset($_GET['lrn'])) {
                                    echo $_GET['lrn'];
                                  } else if (isset($_GET['assessment'])) {
                                    echo $_GET['assessment'];
                                  } else if (isset($_GET['evaluation'])) {
                                    echo $_GET['evaluation'];
                                  } ?>">Back to folders</a>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">
              <h1 class="text-align-center">Student Evaluation GRADE <?php echo $row12['grade']; ?></h1>
            </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
              ...
              <div class="col-md-6 border">
                ...
                ?>
                  <?php if ($eva1['type'] == 1) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name='11dlsds'></textarea> <?php } else {
                                                                                                                                                                                                            echo $eva1['strenght'];
                                                                                                                                                                                                          } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name='11dlsdn'></textarea> <?php } else {
                                                                                                                                                                                                        echo $eva1['needs'];
                                                                                                                                                                                                      } ?> </u></p>
                    <hr>
                  <?php } ?>
                  <?php if ($eva1['type'] == 2) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11seds"></textarea> <?php } else {
                                                                                                                                                                                                            echo $eva1['strenght'];
                                                                                                                                                                                                          } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11sedn"></textarea> <?php } else {
                                                                                                                                                                                                      echo $eva1['needs'];
                                                                                                                                                                                                    } ?> </u></p>
                    <hr>
                  <?php } ?>
                  <?php if ($eva1['type'] == 3) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11ldds"></textarea> <?php } else {
                                                                                                                                                                                                            echo $eva1['strenght'];
                                                                                                                                                                                                          } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11lddn"></textarea> <?php } else {
                                                                                                                                                                                                      echo $eva1['needs'];
                                                                                                                                                                                                    } ?> </u></p>
                    <hr>
                  <?php } ?>
                  <?php if ($eva1['type'] == 4) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11pds"></textarea> <?php } else {
                                                                                                                                                                                                          echo $eva1['strenght'];
                                                                                                                                                                                                        } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11pdn"></textarea> <?php } else {
                                                                                                                                                                                                      echo $eva1['needs'];
                                                                                                                                                                                                    } ?> </u></p>
                    <hr>
                  <?php } ?>
                  <?php if ($eva1['type'] == 5) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11cds"></textarea> <?php } else {
                                                                                                                                                                                                          echo $eva1['strenght'];
                                                                                                                                                                                                        } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11cdn"></textarea> <?php } else {
                                                                                                                                                                                                      echo $eva1['needs'];
                                                                                                                                                                                                    } ?> </u></p>
                    <hr>
                  <?php } ?>
                  <?php if ($eva1['type'] == 6) { ?>
                    ...
                    <p><strong> Strength/s: </strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11bds"></textarea> <?php } else {
                                                                                                                                                                                                          echo $eva1['strenght'];
                                                                                                                                                                                                        } ?> </u></p>
                    <p><strong> Need/s:</strong><u><?php if ($eva1['strenght'] == '') { ?><textarea class='form-control' placeholder='<?php echo $eva1['needs']; ?>' type='text' name="11bdn"></textarea> <?php } else {
                                                                                                                                                                                                      echo $eva1['needs'];
                                                                                                                                                                                                    } ?> </u></p>
                  <?php } ?>
                <?php } ?>
